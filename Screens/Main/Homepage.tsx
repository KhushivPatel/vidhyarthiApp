...
const HomePage: React.FC = () => {
 ...
 const goToProfile = (user: any) => {
  ...
  const handleExamfee = () => {
    // Navigate to the Notification page
    navigation.navigate('Exam_fee');
  };
  const handleHallticket = () => {
    // Navigate to the Notification page
    navigation.navigate('Hall_ticket');
  };
  const handleadmfee = () => {
    // Navigate to the Notification page
    navigation.navigate('ADM_Fees_Receipt');
  };
  const handleResultacademics = () => {
    // Navigate to the Notification page
    navigation.navigate('Result_academics');
  };
  const handlePaperselection = () => {
    // Navigate to the Notification page
    navigation.navigate('Paper_Selection');
  };
  const handleSelectedPaper = () => {
    // Navigate to the Notification page
    navigation.navigate('Selected_Paper');
  };
  const handleDownloadcerti = () => {
    // Navigate to the Notification page
    navigation.navigate('Download_Certificate');
  };
  const handleRequestcerti = () => {
    // Navigate to the Notification page
    navigation.navigate('Request_Certificate');
  };
        ...
        <View style={isDarkMode ? styles.homestyleDark : styles.homestyle}>
          ...
          <View
            ...
            <View
              ...
              <View
                style={
                  isDarkMode ? styles.textContainerDark : styles.textContainer
                }>
                <Text
                  style={[
                    styles.textItem,
              ...
              <TouchableOpacity
                style={isDarkMode ? styles.arrowButtonDark : styles.arrowButton}
                onPress={() => goToProfile(user)}>
                <Image
                  source={require('../../assets/icons/arrow.png')}
                  style={isDarkMode ? styles.arrowDark : styles.arrow}
                />
              </TouchableOpacity>
            </View>
            <Text
              style={[
                isDarkMode ? styles.textItemDark : styles.textItem,
                {fontSize: 14, color: '#000', fontWeight: 'bold'},
              ]}>
              Quick Links
            </Text>
            <View
              style={
                isDarkMode ? styles.linkContainerDark : styles.linkContainer
              }>
              {/* Request Status Touchable */}
              <TouchableOpacity
                style={[
                  isDarkMode
                    ? styles.linkInputWrapperDark
                    : styles.linkInputWrapper,
                  {width: '40%'},
                ]}
                onPress={handleRequestStatusClick}>
                <Text
                  style={isDarkMode ? styles.linkInputDark : styles.linkInput}>
                  Request Status
                </Text>
              </TouchableOpacity>
          ...
          <View
            style={
              isDarkMode
                ? styles.certificateMainContainerDark
                : styles.certificateMainContainer
            }>
            <View
              style={
                isDarkMode
                  ? styles.certificateTitleContainerDark
                  : styles.certificateTitleContainer
              }>
              <Text
                style={
                  isDarkMode
                    ? styles.certificateTitleTextDark
                    : styles.certificateTitleText
                }>
            ...
            <View
              style={
                isDarkMode
                  ? styles.certificatemessageDark
                  : styles.certificatemessage
              }>
              <Text
                style={
                  isDarkMode
              ...
              <Text
                style={
                  isDarkMode ? styles.remarksTextDark : styles.remarksText
                }>
          ...
          <View
            style={
              isDarkMode
                ? styles.educationDetailsContainerDark
                : styles.educationDetailsContainer
            }>
            <View
              style={
                isDarkMode
                  ? styles.greetingTextContainerDark
                  : styles.greetingTextContainer
              }>
              <Image
                source={require('../../assets/icons/book.png')}
                style={isDarkMode ? styles.bookIconDark : styles.bookIcon}
              />
              <Text
                style={
                  isDarkMode ? styles.greetingTextDark : styles.greetingText
                }>
                Educational Details
              </Text>
            </View>
            <TouchableOpacity
              style={
                isDarkMode
                  ? styles.expandDetailsButtonDark
                  : styles.expandDetailsButton
              }
          ...
          <View
            style={
              isDarkMode
                ? styles.ExaminationContainerDark
                : styles.ExaminationContainer
            }>
            <Text
              style={
                isDarkMode ? styles.greetingTextDark : styles.greetingText
            ...
            <View
              style={
                isDarkMode ? styles.rowContainerDark : styles.rowContainer
              }>
              <TouchableOpacity
                style={isDarkMode ? styles.coloredBoxDark : styles.coloredBox}
